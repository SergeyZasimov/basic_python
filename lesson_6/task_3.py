...
tom = Position('Tom', 'Jones', 'manager', 150000, 50000)
for attr in list(tom.__dict__):
    print(f'{attr} = {getattr(tom, attr)}')
full_name = tom.get_full_name()
full_income = tom.get_total_income()
print(f'{full_name} full income {full_income}')